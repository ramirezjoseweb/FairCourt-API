...
| OTP administrativo separado, selección explícita de comunidad, catálogo de instalaciones y reglas básicas editables, política efectiva y auditoría privada | `/admin` y espacio de la comunidad seleccionada | admin |
