...
| OTP administrativo separado, selección explícita de comunidad, catálogo editable de instalaciones, política efectiva y auditoría privada | `/admin` y espacio de la comunidad seleccionada | admin |
